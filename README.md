...
<b>Tip: Compared with virusrecom v1.0, v1.1~1.3 has optimized the parameters of the input file. Besides, since v1.4, virusrecom has updated the input method of lineage mark.</b>

<b>The simple help documentation of virusrecom v1.4.0 is as follows.</b>
...
```
#sequence name	lineage name
query_recombinant_seq00001	query_recombinant
query_recombinant_seq00002	query_recombinant
...........Omit multiple lines here.........
reference_lineage_1_seq00001	reference_lineage_1
reference_lineage_1_seq00002	reference_lineage_1
...........Omit multiple lines here.........
reference_lineage_2_seq00018	reference_lineage_2
reference_lineage_2_seq00019	reference_lineage_2
...........Omit multiple lines here.........
reference_lineage_9_seq00099	reference_lineage_9
reference_lineage_9_seq00100	reference_lineage_9
```

Note, the sequence name in ```sequence_lineage_mapping.txt``` needs to be consistent with the file `alignment_lineages_data.fasta`. <b>The name of each lineage in the file ```sequence_lineage_mapping.txt``` should be unique</b>, otherwise, there will be duplicate matches in subsequent analysis. The sequence name and the lineage name are separated by a tab.
