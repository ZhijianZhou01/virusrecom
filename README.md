...
**Note, the sentence "In fact, recombination events with p-values below 0.001 are less reliable" is misexpressed in the previously uploaded manuals, the correct one is "In fact, recombination events with p-values over 0.001 are less reliable". (calibration in 2023-08-11)**


## 1. Download and install

VirusRecom is developed via ```Python 3```, and you can get and install VirusRecom in a variety of ways.
