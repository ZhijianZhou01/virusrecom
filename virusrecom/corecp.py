...
from my_func import (make_dir, mwic_calculation,merge_intervals,
...
def virus_infor_calculate(seq_file_path,
    ...
    if site_ic_csv_path == "":
        ...
        print(">>> Treat " + query_lineage_name + " as a potential recombination lineage..." + "\n")
    ...
    ref_lineage_name_list = list(sites_probability_data.columns[2:])

    # print(ref_lineage_name_list)
    ...
    if not parameter_dic["no_wic_figure"]:
        ...
        wic_plot(ref_lineage_name_list, original_site_list,
                 sites_probability_data, query_lineage_name, site_ic_fig)
    ...
    for each_lineage in recom_region_dic:
        region_list_ = recom_region_dic[each_lineage]

        region_list = merge_intervals(region_list_)
    ...
    if cumulative_major.upper() == "Y":
        ...
        for lineage in ref_lineage_name_list:
